 ...
 if(!isset($_SESSION['user'])|| empty($_SESSION['user']))
  {
     ...
     exit;
        ...
        $year=$_GET['b'];
        if ($year == '1'){
         $_SESSION['yearforloadchart']="1";
                  }
        if ($year == '2'){
            $_SESSION['yearforloadchart']="2";
        }
        if ($year == '3'){
            $_SESSION['yearforloadchart']="3";
        }
...
<center><br><br><br><br><br><br><br><br><br><br>
							...
							<div data-date-format="yyyy-mm-dd" data-date="document.write(date())" class="input-append date myDatepicker">
							    <input type="text" value="" name="doj1" size="16" class="span2" required style="height:20px" placeholder="Starting Date Of The Week">
							   <span class="add-on"><i class="icon-calendar"></i></span>
							</div>
							<br>
														<div data-date-format="yyyy-mm-dd" data-date="document.write(date())" class="input-append date myDatepicker">
							    <input type="text" value="" name="doj2" size="16" class="span2" required style="height:20px" placeholder="End Date Of The Week">
							   <span class="add-on"><i class="icon-calendar"></i></span>
							</div>
<br>
