...
$sql = "SELECT * FROM `login` WHERE `username`='AIC'";
...
<html lang="en">
    ...
    <head>
        ...
        <title>Nec Class Allocator</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1 style="color:black"><strong>Nec Class Allocator</strong></h1>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="admin_dash.php" method="post" class="login-form">
