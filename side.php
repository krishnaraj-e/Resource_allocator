...
<span class="glyphicon glyphicon-search" id="help2"></span>
</div>

<div id="mySidenav" class="sidenav">
  <a href="dashboard_body.php" target="body" id="about">Home </a>
  <a href="select_dept_for_allocation.php" target="body" id="blog">Allocate</a>
  <a href="select_dept_for_deallocation.php" target="body" id="projects">De-Allocate</a>
...
<a href="select_date_for_overview.php" target="body" id="help">Overview </a>
