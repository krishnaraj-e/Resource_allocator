...
$sql1="SELECT `incharge` FROM `resource` WHERE `name`='".$area."'";
$result=mysqli_query($conn, $sql1);
$row=$result->fetch_assoc();
$incharge=$row['incharge'];


$sql2="INSERT INTO `dofi`(`by`, `date`, `issue`, `suggestion`, `state`, `resource`, `incharge`) VALUES ('".$_SESSION['user']."','".date('y-m-d')."','".$problem."','".$suggetion."','OPEN','".$area."','".$incharge."')";
...
if(!$result)
	...
	else
	{
          ...
          echo "</div>";
          echo "</div>";
          echo "<center><h2>&nbsp;&nbsp;&nbsp;DOFI Reported....!</center></h2>";
	}
