...
<div class="topnav">
  ...
  <a href="select_year_for_deallocation.php" target="body">De-Allocate</a>
  <a href="select_year_for_time_table.php" target="body">Time Table</a>
  <a href="time_for_spot_allocation.php" target="body">Spot Allocation</a>
  <a href="dofi_options.php" target="body">DOFI</a>
  <a href="select_resource_for_load_chart.php" target="body" >Load Chart</a>
    <a href="freez.php" target="body" >Freeze Class</a>
